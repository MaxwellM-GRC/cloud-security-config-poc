...
5. Publish immutable run evidence, detect exceptions, and route stable finding
   IDs.
6. Require authorized people to approve remediation, exceptions, risk
   acceptance, and closure. Preserve configuration before and after the change
   and the exposure period lookback.
